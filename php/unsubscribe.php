							...
							<div class="parsys contentpagewelcome-parsys">
								<div class="section">
									...
									<div class="panel ucg_seo_title">
										<div class="container">
											<h1 class="singlePage">Unsubscribe from mail alerts</h1>
										</div>
									</div>
									<!-- /END TITLE SEO -->
								</div>
								...
								<div class="section">
									...
									<div class="panel ucg_image_text">
										<div class="container">
											<div class="ucg_txt">
												<p>
													If you wish to unsubscribe from the e-amil alert service, please fill data and submit the form
												</p>
											</div>
										</div>
									</div>
										...
										<div class="container">
											<form name="unsubscribeForm">
												<div class="alert alert-danger alert-dismissible fade in">
													You made <span class="ucg_error_num">2</span> errors filling the form, please check
													<button type="button" class="close" data-dismiss="alert">&times;</button>
												</div>
												<div class="formSectionContainer col-xs-12 col-sm-8 clearfix">
													<div class="ucg_formRow">
												...
												<div class="panel ucg_button">
													<div class="container">
														<button type="submit" class="btn ucg_button_confirm" title="submit">Unsubscribe</button>
													</div>
												</div>
												<!-- /END BUTTON -->
											</form>
