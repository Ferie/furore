...
<html lang="it">
	<head>
		...
		<title>Calendar Detail Portrait</title>
					...
					<div class="mainContainer-wrapper">
						...
						<div id="calendar">
							<div id="singleEvent">
								...
								<div  class="portraitPhoto body panel event">
									<div class="container">
									...
									<div class="container">
										<div class="image col-xs-12 col-sm-5">
											<img src="../img/cover_portrait_001.jpg" alt="Image of the poster of the concert" title="Image of the poster of the concert">
										</div>
