...
<head>
    ...
    <title>Our worldwide presence | Bank Austria</title>
	...
	<div class="body-container-cell">
		<div id="mainContainer">
			...
			<!-- PAGE START HERE -->
								...
								<div class="panel ucg_breadcrumb_crumbs col-xs-12">
									<div class="container">
										<ul>
											...
											<li><a href="worldwideCountry.html">Austria</a></li>
											<li>Bank Austria</li>
										</ul>
									</div>
								</div>
				...
				<div id="worldwide">
					<div class="panel" id="companyTitle">
						<div class="container">
							<h1>Bank Austria</h1>
						</div>
					</div>
	
					<div class="panel" id="companyInfos">
						<div class="container">
							<div class="inner col-xs-12 col-sm-3 left">
								<div class="logo">
									<img src="img/static/Bank_Austria_logo.png">
								</div>
							</div>
							<div class="inner col-xs-12 col-sm-9 right">
								<div class="mappa">
							...
							<div class="inner col-xs-12 col-sm-3 left">
								...
								<div class="infos">
									<div class="info">Schottengasse 6-8</div>
									<div class="info">1010 - Vienna</div>
									<div class="info">Austria</div>
									<div class="getDirections"><a href="javascript:void(0);">Get directions</a></div>
								</div>
								<div class="subtitle">Main Contacts</div>
								<div class="infos">
									<div class="info">phone: +43 50505 25</div>
									<div class="info"><a href="mailto:info@unicreditgroup.at">info@unicreditgroup.at</a></div>
								</div>
								<div class="subtitle links companyLessInfoOff">
									Links
									<span class="arrow visible-xs"></span>
								</div>
								<div class="externalLinkAndIconsContainer">
									<div class="externalLinkContainer companyLessInfoOff">
										<div class="externalLink">
											<a href="http://www.bankaustria.at" target="_blank">bankaustria.at</a>
										</div>
									</div>
									<div class="icons companyLessInfoOff">
								...
								<div class="companyInfo companyLessInfoOn">
									<div class="companyInfoTitle">
										Company info
										<span class="arrow visible-xs"></span>
									</div>
									<div class="companyInfoBody"><b>Type:</b> Representative office<br></div>
								</div>
							</div>
							<div class="inner col-xs-12 col-sm-9 right">
								<div class="companyInfo companyLessInfoOff">
									<div class="companyInfoTitle">
										Company info
										<span class="arrow visible-xs"></span>
									</div>
									<div class="companyInfoBody">
										...
										<p class="title"><b>Market leader in Austria</b></p>
										<p>
										...
										<p class="title"><b>The largest network in Central and Eastern Europe</b></p>
										<p>
										...
										<p class="title"><b>Recognised excellence</b></p>
										<p>
