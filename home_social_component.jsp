...
<head>
	...
	<!--specific CSS for Link List Component-->
	<link type="text/css" rel="stylesheet" href="css/ucg_link_component.css"/>
	
	<!--specific CSS for Social Component-->
					...
					<div class="parsys_column two-columns-box-c0">
						<div class="panel ucg_social ucg_social_twitter">
							<div class="container">
								<div class="ucg_social_title">Unicredit champions facebook</div>
								<div class="ucg_social_image">
									<img alt="" src="img/social-twitter-c2.jpg">
								</div>
								<div class="clear visible-xs"></div> 
								<div class="ucg_social_data">
									<span>21 November</span>
								...
								<div class="ucg_social_text">
									<p><a class="tag" href="javascript:void(0);">#Unicredit</a>: la <a class="tag" href="javascript:void(0);">#Turchia</a> rappresenta uno dei principali mercati di sbocco per molte eccellenze del territorio laziale</p>
								</div>
							</div>
							<div class="container">
								<div class="ucg_social_link">
					...
					<div class="parsys_column two-columns-box-c1">
						<div class="panel ucg_social ucg_social_googleplus">
							<div class="container">
								...
								<div class="ucg_social_image">
									<img alt="" src="img/social-googleplus-c2.jpg">
								</div>
								<div class="clear visible-xs"></div> 
								<div class="ucg_social_data">
									<span>28 November</span>
								...
								<div class="ucg_social_text">
									<p>Erogato il primo finanziamento in equity di UniCredit Start Lab in compartecipazione con il partner LVenture Group <a class="tag" href="javascript:void(0);">#Unicredit</a></p>
								</div>
							</div>
							<div class="container">
								<div class="ucg_social_link">
