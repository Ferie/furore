...
<html lang="it">
	<head>
		...
		<title>Calendar Detail Landscape</title>
			...
			<div class="body-container-cell">
				<div id="mainContainer">
					<div class="mainContainer-wrapper">
						...
						<div id="calendar">
							<div id="singleEvent" class="panel">
								<div class="title panel">
									<div class="container">
										<h1>UniCredit Sponsors Turin Concert Marking Fall of Berlin Wall</h1>
									</div>
								</div>
								<div  class="landscapePhoto body panel event">
									<div class="container">
									...
									<div class="container">
										<div class="body col-xs-12">
											<img src="../img/cover_landscape_001.jpg" alt="Image of Turin's Teatro Regio" title="Image of Turin's Teatro Regio">
										</div>
									</div>
									<div class="container">
