...
<html lang="it">
	<head>
		...
		<!--specific CSS for Worldwide Our Presence Component-->
			...
			<div class="body-container-cell">
				<div id="mainContainer">
					<div class="mainContainer-wrapper">
						...
						<div class="example">Our Worldwide Presence Component</div>
							...
							<div class="example">Our Worldwide Presence Component in a CQ5 2 columns (1/3 - 2/3)</div>
							<div class="panel ucg_title ucg_no_image">
								<div class="container">
									<div class="ucg_cols ucg_cols_text col-xs-12">
										<div class="ucg_title_container">
