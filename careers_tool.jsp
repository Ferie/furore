...
<html lang="it">
	<head>
		...
		<!-- CAREERS TOOL SPECIFIC CSS -->
		<link type="text/css" rel="stylesheet" href="css/careers_tool.css"/>
						...
						<div id="careersTool">
							...
							<div class="parsys contentpagewelcome-parsys">
								<div class="section">
									...
									<div class="panel ucg_seo_title">
										<div class="container">
											<h1 class="singlePage">Search job opportunities by Country</h1>
										</div>
									</div>
									<!-- /END TITLE SEO -->
								</div>
							...
							<div class="parsys_column three-columns-box clearfix">
								<div class="parsys_column three-columns-box-c0">
									<div class="country">
										<div class="countryName">Italy, Austria</div>
										<!-- LINKLIST -->
										<div class="panel ucg_linklist">
											<div class="container">
												<div class="ucg_link_container">
													<div class="ucg_internal_link">
														<a href="javascript:void(0);" target="_blank">Apply now</a>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="container">
												<div class="ucg_link_container">
													<div class="externalLink">
														<a href="javascript:void(0);" target="_blank">Careers at Unicredit Bulbank</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="country">
										...
										<div class="panel ucg_linklist">
											<div class="container">
												<div class="ucg_link_container">
													<div class="externalLink">
														<a href="javascript:void(0);" target="_blank">Careers at HypoVereinsbank</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="country">
										<div class="countryName">Croatia</div>
										<!-- LINKLIST -->
										<div class="panel ucg_linklist">
											<div class="container">
												<div class="ucg_link_container">
													<div class="externalLink">
														<a href="javascript:void(0);" target="_blank">Careers at Zagreback Banka</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="country">
										<div class="countryName">Hungary</div>
										<!-- LINKLIST -->
										<div class="panel ucg_linklist">
											<div class="container">
												<div class="ucg_link_container">
